...
namespace questions
{
    ...
    //direction starting from root.Boundary includes left boundary, leaves, and right 
    //boundary in order without duplicate nodes.
    ...
    //doesn't have left subtree or right subtree, then the root itself is left boundary 
    //or right boundary. Note this definition only applies to the input binary tree, 

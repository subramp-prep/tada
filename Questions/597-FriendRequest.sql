...
others’ requests as well. Now given two tables as below:
...
you just need to simply count the total accepted requests (no matter whether 
they are in the original requests), and divide it by the number of requests to get the acceptance rate.
